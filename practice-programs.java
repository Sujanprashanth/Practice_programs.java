...
class Main{
	public static void main(String[]args){
		...
		for(int i=0;i<size;i++){
			...
			lmap.put(name,number);
		}
		while(sc.hasNextLine()){
			String query = sc.nextLine();
			if(hmap.containsKey(query)){
				System.out.println(query+"="+lmap.get(query));
			}
			else{
...
30
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
Linked List Insert at the end and Traversal in Java
Program:
class Node{
	int data;
	Node next;
...
class Result {
    ...
    public void compareTriplets(List<Integer> a, List<Integer> b) {
        List<Integer> c = new ArrayList<>();
        int a_sum=0,b_sum=0,i=0,j=0;
